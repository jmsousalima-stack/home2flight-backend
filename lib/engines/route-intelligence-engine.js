// /lib/engines/route-intelligence-engine.js
...
function normalizeMode(mode) {
  ...
  if (["bike", "bicycle", "cycling"].includes(value)) return "bicycling";
...
export async function getRouteOperationalIntelligence({
  ...
  try {
    ...
    const trafficDeltaMinutes = liveTrafficDurationMinutes - baseDurationMinutes;
    ...
    return {
      ...
      intelligenceFlags: [
        {
          type: normalizedMode === "driving" ? "live_traffic" : "route_estimate",
          label:
            normalizedMode === "driving"
              ? "Trânsito live ativo"
...
export default getRouteOperationalIntelligence;