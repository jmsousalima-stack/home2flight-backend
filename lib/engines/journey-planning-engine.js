...
const ENGINE_VERSION = "2.0.0-border-intelligence-integrated-lib";
...
function getEffectiveFlightType({ requestedFlightType, borderIntelligence }) {
  ...
  return normalizeFlightType(requestedFlightType);
}
...
export async function runJourneyPlanningEngine({
  ...
  return {
    ...
    sources: {
      ...
      events: eventInfo,
      weather: weatherInfo,
      border: borderIntelligence?.summary || borderIntelligence?.borderDecision || null,
