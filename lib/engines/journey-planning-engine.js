...
const ENGINE_VERSION = "1.9.8-operational-signal-fusion-lib";
...
export async function runJourneyPlanningEngine({
  ...
  const operationalSignals = signalFusion?.signals || rawOperationalSignals;
  ...
  return {
    ...
    timeline: [
      {
        ...
        status: "buffer",
        source:
          "Journey Planning Engine + Operational Signal Fusion + Flight Source Arbitration + Weather Intelligence + Reliability Arbitration + Buffer Governance + Signal Priority",
    ...
    diagnostics: {
      ...
      fusedOperationalSignalCount: operationalSignals.length,
