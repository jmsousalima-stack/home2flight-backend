...
export async function runJourneyPlanningEngine({
  ...
  if (!departureResolution.departureTime) {
    return {
      ...
      version: "1.9.2-weather-integrated-lib",
      error:
    ...
    timeline: [
      {
        ...
        status: "buffer",
        source:
          "Journey Planning Engine + direct /lib engines + Weather Intelligence + Reliability Arbitration + Buffer Governance + Signal Priority",
