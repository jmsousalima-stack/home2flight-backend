...
const ENGINE_VERSION = "1.9.9-operational-memory-integrated-lib";
...
function buildLeaveHomeReasoning(signalPriority, operationalMemory) {
  ...
  if (dominantRiskSignals.length > 0 && supportingRiskSignals.length > 0) {
    return `A decisão foi principalmente influenciada por: ${dominantText}. Também foram considerados: ${supportingText}.${suffix}`;
  }

  if (dominantRiskSignals.length > 0) {
    return `A decisão foi principalmente influenciada por: ${dominantText}.${suffix}`;
  }
  ...
  if (confidenceSupportSignals.length > 0) {
    return `Não existem riscos dominantes. A decisão é suportada por sinais positivos de confiança: ${confidenceText}.${suffix}`;
  }
    ...
    timeline: [
      {
        ...
        status: "buffer",
        source:
          "Journey Planning Engine + Operational Signal Fusion + Operational Memory + Flight Source Arbitration + Weather Intelligence + Reliability Arbitration + Buffer Governance + Signal Priority",
      ...
      },
      {
        ...
        status: "buffer",
        source:
          "Airport Intelligence Engine + Operational Memory + Weather Intelligence + Buffer Governance",
        liveInsight:
      ...
      },
      {
        ...
        trustLevel: "medium",
        status: "buffer",
        source: "Airport Intelligence Engine + Weather Intelligence + Operational Memory",
      ...
      },
      {
        ...
        source: "Flight type model + Operational Memory",
      ...
      },
      {
        ...
        trustLevel: "medium",
        status: "ready",
        source: "Gate timing model + Operational Memory",
